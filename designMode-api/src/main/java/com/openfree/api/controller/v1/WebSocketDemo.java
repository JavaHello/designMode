...
public class WebSocketDemo extends BaseController {
...
//    private static CopyOnWriteArraySet<WebSocketDemo> webSocketSet = new CopyOnWriteArraySet<WebSocketDemo>();
    ...
    public void onOpen(Session session) {
        ...
        WebSocketPushUtil.add(this); //加入set中
        addOnlineCount(); //在线数加
    ...
    @OnClose
    public void onClose() {
        WebSocketPushUtil.remove(this); //从set中删除
        subOnlineCount(); //在线数减
    ...
    public void onMessage(String message, Session session) {
        ...
        //群发消息
        WebSocketPushUtil.pushAll(message);
    }
...
//this.session.getAsyncRemote().sendText(message);
    ...
    public static void addOnlineCount() {
        WebSocketDemo.onlineCount.addAndGet(1);
    }
